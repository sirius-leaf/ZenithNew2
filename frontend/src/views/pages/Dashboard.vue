      ...
      <section>
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div class="flex items-center justify-between mb-5">
            ...
            <span
              class="text-xs font-medium px-2.5 py-0.5 rounded-full bg-purple-100 text-purple-800"
            >
              Kosong
            </span>
          </div>
          ...
          <div
            class="flex flex-col items-center justify-center py-12 px-6 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300"
          >
            <div
              class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center mb-4"
            >
              <svg

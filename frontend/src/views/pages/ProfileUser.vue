...
const submitForm = async () => {
  ...
  try {
    ...
    alert(`Pendaftaran toko "${storeName.value}" berhasil diajukan! Menunggu konfirmasi admin.`);
    ...
    console.error('Gagal mengajukan jadi seller:', error.response?.data || error);

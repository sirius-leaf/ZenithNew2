<template>
  <div class="w-full bg-gray-50 p-4 sm:p-6">
    ...
    <div v-else class="max-w-2xl mx-auto bg-white rounded-xl shadow-md p-6">
      <h2 class="text-lg font-semibold text-neutral-950 mb-6">
        Informasi Akun
      </h2>
      ...
      <div class="space-y-6">
        <div class="flex items-start gap-4">
          <div
            class="w-10 h-10 bg-pink-50 rounded-lg flex justify-center items-center"
          >
            <svg
        ...
        <div class="flex items-start gap-4">
          <div
            class="w-10 h-10 bg-blue-50 rounded-lg flex justify-center items-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
    ...
    <!-- Buka Toko Section -->
    <div
      class="max-w-2xl mx-auto mt-6 bg-gradient-to-r from-pink-50 to-blue-50 rounded-xl p-6 shadow-md"
    >
      <div class="flex items-start gap-4">
        <div
          class="w-12 h-12 bg-white rounded-full border-2 border-pink-500 flex justify-center items-center shadow-sm"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div>
          <h3 class="text-lg font-semibold text-neutral-950 mb-2">
            Buka Toko Anda Sendiri
          </h3>
          <p class="text-sm text-gray-600 mb-4">
            Jadilah penjual dan raih penghasilan dengan membuka toko di platform
            kami. Proses pendaftaran mudah dan gratis!
          </p>
          <button
            @click="openStore"
          ...
          >
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      class="w-full text-xs text-gray-500 file:mr-2 file:py-1.5 file:px-3 file:rounded file:border-0 file:text-xs file:font-medium file:bg-pink-50 file:text-pink-600"
                    />
                  </div>
                  <div>
                    <label class="block text-gray-700 text-sm font-medium mb-1"
            ...
            <div class="px-6 py-4 bg-gray-50 flex justify-between gap-3">
              <button
                v-if="currentStep === 2"
                @click="prevStep"
                class="px-4 py-2.5 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-100"
              >
                Kembali
              </button>
